%%------NAME Script 1 Breadcrumbssinglecratergenerator
%%---This code is a copy of the presented in this github space https://github.com/adririquelme/singlecratergenerator/blob/main/generate_a_single_crater.m
%%---This code was placed there because A Riquelme has an space in github
%%---This code was used in Improving filtering methods based on the Fast Fourier Transform to delineate objective relief domains: An application to Mare Ingenii lunar area
%%--- correspond with González-Díez et al., 2022a A. González-Díez, J.A. Barreda-Argüeso, L. Rodríguez-Rodríguez, A. Riquelme; located in adririquelme/Single Crater Generator script. [WWW Document]. 
%%--- URL  https://github.com/adririquelme/singlecratergenerator 
